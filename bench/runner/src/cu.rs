...
const PUBLIC_OPS: &[(u8, &str)] = &[
    ...
    (164, "mul_div_ceil_wide"),
    (165, "isqrt_wide"),
    (166, "sqrt_floor_wide"),
    (167, "sqrt_ceil_wide"),
    (168, "exp2_lower_wide"),
    (169, "exp2_upper_wide"),
    (170, "exp2_bounds_wide"),
    (171, "log2_lower_wide"),
    (172, "log2_upper_wide"),
    (173, "log2_bounds_wide"),
    (174, "pow_lower_wide"),
    (175, "pow_upper_wide"),
    (176, "pow_bounds_wide"),
    (177, "powi_lower_wide"),
    (178, "powi_upper_wide"),
    (179, "compound_lower_wide"),
    (180, "compound_upper_wide"),
    (181, "compound_bounds_wide"),
    (182, "defi::fee::net_of_fee_wide"),
    (183, "defi::amm::quote_exact_in_wide"),
    (184, "defi::amm::quote_exact_out_wide"),
    (185, "defi::amm::initial_lp_shares_floor_wide"),
    (186, "defi::lending::utilization_bps_wide"),
    (187, "defi::lending::borrow_rate_bps_wide"),
    (188, "defi::staking::reward_index_accrue_lower_wide"),
    (189, "defi::staking::reward_index_accrue_upper_wide"),
    (31, "defi::staking::reward_index_accrue_wide"),
    (32, "defi::staking::rewards_owed_floor_wide"),
    (33, "defi::oracle::price_bounds_scaled_wide"),
    (34, "defi::schedule::vested_floor_wide"),
    (35, "defi::schedule::linear_interp_floor_wide"),
    (36, "defi::schedule::linear_interp_ceil_wide"),
];
